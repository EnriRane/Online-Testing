                ...
                <div class="report">
                    ...
                    <?php 
                        if(isset($_GET['id_student']))
                        {
                            ...
                            echo "<h2>Rezultati i :".$full_name."</h2>";
                        }
                        else
                        {
                            header('location:'.SITEURL.'admin/index.php?page=dashboard');
                        }
                        if(isset($_GET['data_krijimit']))
                        {
                        ...
                        while($row=$obj->fetch_data($res))
                        {
                            ...
                            ?>
                            <label>Pergjigjet e perdoruesit: </label>
                            <?php 
                            ...
                            <br />
                            <label>Pergjigjia e sakte:</label><label style="color: green;"><?php echo $pergjigjaSakte; ?></label><br />
                    ...
                    ?>
                        <a href="<?php echo SITEURL; ?>admin/index.php?page=dashboard">
                            <button type="button" class="btn-add">Shko te Menuja kryesore</button>
                        </a>
